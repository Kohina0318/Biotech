        ...
        <div className="row">
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
            <div className="ps-block--contact-info">
              ...
              <p>
                                <a href="mailto:esupport@biotechhealthcare.com">esupport@biotechhealthcare.com</a>
          ...
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
            <div className="ps-block--contact-info">
              ...
              <p>
                <a href="#!">customercare@biotech.com</a>
          ...
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
            <div className="ps-block--contact-info">
              ...
              <p>
                <a href="#!">vendorsupport@biotech.com</a>
