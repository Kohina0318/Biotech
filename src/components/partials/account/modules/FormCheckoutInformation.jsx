...
class FormCheckoutInformation extends Component {
  handleLoginSubmit = () => {
    this.props.history.push("/account/shipping");
  };

  render() {
    const { amount, cartItems, cartTotal } = this.props;
    return (
      <Form className="ps-form--checkout" onFinish={this.handleLoginSubmit}>
...
export default withRouter(FormCheckoutInformation);
