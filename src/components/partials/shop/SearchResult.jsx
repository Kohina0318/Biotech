...
import { getProducts, getProductsByKeyword } from "redux/product/action";
          ...
          <div className="ps-shopping">
            <div className="ps-shopping__header">
              {allProducts && allProducts.length > 0 ? (
                <p>
                  <strong>{allProducts ? allProducts.length : 0}</strong>
                  <span className="ml-1">{languageLable(selectedLanguageData, "Products found")}</span>
                </p>
              ) : (
