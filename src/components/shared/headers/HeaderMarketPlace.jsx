        ...
        <div className="header__top">
          <div className="container">
            <div className="header__left">
              <p>Welcome to biotech Online Shopping Store !</p>
            </div>
            <div className="header__right">
              <ul className="header__top-links">
                <li>
                  <Link to="/vendor/store-list">Store Location</Link>
                </li>
                <li>
                  <Link to="/page/blank">Track Your Order</Link>
                </li>
                <li>
                  <CurrencyDropdown />
                </li>
        ...
        <div className="header__content">
          <div className="container">
            <div className="header__content-left">
              <Link to="/home/market-place">
                <a className="ps-logo">
                  <img src="/static/img/logo.png" alt={process.env.REACT_APP_NAME} />
                </a>
              </Link>
